...
# Bot images & videos
PICS = (environ.get('PICS', 'https://telegra.ph/file/3df938d22b08cbc4fe5eb.jpg')).split()
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5313004751 1017302540').split()]
